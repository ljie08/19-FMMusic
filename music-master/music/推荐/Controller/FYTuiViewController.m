...
@interface FYTuiViewController ()<UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,FYPickerViewDelegate,scrollDelegate, FYTitleViewDelegate>
...
-(void)initUI{
    ...
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width-20, 44)];
...
-(void)initTableView{
    ...
    for (int i = 0; i < 3; i ++ ){
        if(i == 0){
            ...
            _tableView0 = [[UITableView alloc]initWithFrame:CGRectMake(self.view.frame.size.width * i, 64, s_WindowW, s_WindowH) style:UITableViewStyleGrouped];
            ...
            _tableView1 = [[UITableView alloc]initWithFrame:CGRectMake(self.view.frame.size.width * i, 64, s_WindowW, s_WindowH) style:UITableViewStyleGrouped];
            ...
            _tableView2 = [[UITableView alloc]initWithFrame:CGRectMake(self.view.frame.size.width * i, 64, s_WindowW, s_WindowH) style:UITableViewStyleGrouped];
...
-(UIButton *)button0{
    ...
    if (!_button0){
        ...
        [_button0 setTitleColor:FontLightColor forState:UIControlStateNormal];
...
-(UIButton *)button1{
    ...
    if (!_button1){
        ...
        [_button1 setTitleColor:WhiteColor forState:UIControlStateNormal];
...
-(UIButton *)button2{
    ...
    if (!_button2){
        ...
        [_button2 setTitleColor:FontLightColor forState:UIControlStateNormal];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if ([str isEqualToString:@"FYTuiScrollView"]){
        if (scrollView.contentOffset.x == 0){
            ...
            [self.button0 setTitleColor:WhiteColor forState:UIControlStateNormal];
            [self.button1 setTitleColor:FontLightColor forState:UIControlStateNormal];
            [self.button2 setTitleColor:FontLightColor forState:UIControlStateNormal];
            ...
            [self.button0 setTitleColor:FontLightColor forState:UIControlStateNormal];
            [self.button1 setTitleColor:WhiteColor forState:UIControlStateNormal];
            [self.button2 setTitleColor:FontLightColor forState:UIControlStateNormal];
            ...
            [self.button0 setTitleColor:FontLightColor forState:UIControlStateNormal];
            [self.button1 setTitleColor:FontLightColor forState:UIControlStateNormal];
            [self.button2 setTitleColor:WhiteColor forState:UIControlStateNormal];
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView{
    if (tableView.tag == 100) {
        ...
        return self.moreVM.sectionNumber-1;
    }else{
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (tableView.tag == 100) {
        ...
        FYTitleViewCell *cell = [[FYTitleViewCell alloc] initWithTitle:[self.moreVM mainTitleForSection:section] hasMore:[self.moreVM hasMoreForSection:section] titleTag:section];
        cell.delegate = self;
        return !section ? nil : cell;
    }else{
        return nil;
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView.tag == 100) {
        ...
        if (indexPath.section == 0) {
            ...
            cell.imageView.image = [UIImage imageNamed:@"risk"];
            ...
            [cell.coverBtn setImageForState:UIControlStateNormal withURL:[self.moreVM coverURLForIndexPath:indexPath] placeholderImage:[UIImage imageNamed:@"holder"]];
...
- (void)alertTextFiledDidChanged{
    [self showWaitingWithMessage:@"清理中"];
    [[SDImageCache sharedImageCache] clearMemory];
    [self.tableView0 reloadData];
    [self.tableView1 reloadData];
    [self.tableView2 reloadData];
    [self hideWaiting];
    [self showMassage:@"清理完成"];
}
